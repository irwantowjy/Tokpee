    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="HomepageKejarDiskon.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="HomepageData.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
                </div>
        ...
        <div class="content-wrapper">
          <div class="card" style="padding:10px 24px;">
              ...
              <div class="card-body">
                <h4 class="card-title" style="padding:12px 24px;">Items Data</h4>    
                    <div class="table-responsive table-wrapper"  >
                        ...
                        <tbody>
                            <?php
                                $result = $conn->query("SELECT * FROM tbl_admin_diskon");
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<tr>';
                                    echo "<td style='padding:12px 24px;'>{$title}</td>";
                                    echo "<td style='padding:12px 24px;'>{$dsc}</td>";
                                    echo "<td style='padding:12px 24px;'>{$before}</td>";
                                    echo "<td style='padding:12px 24px;'>{$after}</td>";
                                    echo "<td style='padding:12px 24px;'>{$avail}</td>";
            ...
            <?php
                  ...
                  <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                              <label for="itemTitle" class="col-sm-3 col-form-label">Item Title</label>
                              <div class="col-sm-6">
                                  <input type="text" required name="title" value="<?php if (isset($tmp)) echo $tmp['item_title']; ?>" class="form-control" id="itemTitle" placeholder="Title">
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" required name="discountValue" value="<?php if (isset($tmp)) echo $tmp['discount_value']; ?>" class="form-control" id="discountValue" placeholder="Discount Value">
                              </div>
                          </div>
              
                          <div class="form-group row">
                              <label for="itemPrice" class="col-sm-3 col-form-label">Price Before Discount</label>
                              <div class="col-sm-6">
                                  <input type="text" required name="priceBefore" value="<?php if (isset($tmp)) echo $tmp['price_before']; ?>" class="form-control" id="itemPrice" placeholder="Price Before">
                              </div>
                          </div>
              
                          <div class="form-group row">
                              <label for="itemPrice" class="col-sm-3 col-form-label">Price After Discount</label>
                              <div class="col-sm-6">
                                  <input type="text" required name="priceAfter" value="<?php if (isset($tmp)) echo $tmp['price_after']; ?>" class="form-control" id="itemPrice" placeholder="Price After">
                              </div>
                          </div>
              
                          <div class="form-group row">
                              <label for="itemPrice" class="col-sm-3 col-form-label">Item Availability</label>
                              <div class="col-sm-6">
                                  <select name="availability" class="form-control" required>
                                      <option value="Tersedia" <?php if (isset($tmp) && $tmp['availability'] === 'Tersedia') echo 'selected'; ?>>Tersedia</option>
                                      <option value="Tidak Tersedia" <?php if (isset($tmp) && $tmp['availability'] === 'Tidak Tersedia') echo 'selected'; ?>>Tidak Tersedia</option>
                                  </select>
                              </div>
                          </div>
              
                          <div class="form-group row">
                              <label for="itemImage" class="col-sm-3 col-form-label">Add Image</label>
                              <div class="col-sm-6">
                                  <input type="file" accept="image/*" name="itemImage" class="form-control" id="itemImage" required>
                              </div>
                          </div>
              ...
              if (isset($_POST['submitEdit'])) {
                  ...
                  updateItem($id, $title, $value, $priceBefore, $priceAfter, $avail, $pict);
              }
                else{
                    ?>
                    <div class="card-body" >
                        <h4 class="card-title">Diskon Data</h4>             
                        <form class="forms-sample" method="post" enctype="multipart/form-data">

                            <div class="form-group row">
                                <label for="itemTitle" class="col-sm-3 col-form-label">Item Title</label>
                                <div class="col-sm-6">
                                    <input type="text" required name="title" class="form-control" id="itemTitle" placeholder="Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="discountValue" class="col-sm-3 col-form-label">Discount Value</label>
                                <div class="col-sm-6">
                                    <input type="text" required name="discountValue" class="form-control" id="discountValue" placeholder="Discount Value">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="itemPrice" class="col-sm-3 col-form-label">Price Before Discount</label>
                                <div class="col-sm-6">
                                    <input type="text" required name="priceBefore"  class="form-control" id="itemPrice" placeholder="Price Before">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="itemPrice" class="col-sm-3 col-form-label">Price After Discount</label>
                                <div class="col-sm-6">
                                    <input type="text" required name="priceAfter"  class="form-control" id="itemPrice" placeholder="Price After">
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label for="itemPrice" class="col-sm-3 col-form-label">Item Availbility</label>
                                <div class="col-sm-6">
                                    <select name="availbility" class="form-control" required>
          ...
          <?php
            if(isset($_POST['submitAdd'])){
                ...
                $priceBefore = $_POST['priceBefore'];
                $priceAfter = $_POST['priceAfter'];
                $avail = $_POST['availbility'];
                $image = $_FILES['itemImage'];
                $pict = uploadImage('DataImage', $image);

                $sql = "INSERT INTO tbl_admin_diskon (item_title, discount_value, price_before, price_after, availbility, item_image) VALUES ('$title', '$value', '$priceBefore', '$priceAfter', '$avail', '$pict')";
                if ($conn->query($sql)) {
                    ?>
                      <script>
                        Swal.fire({
                        ...
                        text: 'Data Has Been Added',
                            ...
                            window.location = "homepageKejarDiskon.php";
                        })
                      </script>
                    <?php
                }      
