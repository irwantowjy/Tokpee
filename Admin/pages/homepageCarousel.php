  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="HomepageCarousel.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      ...
      <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Homepage - Carousel</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Homepage - Carousel</h6>
      </nav>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card" style="padding:10px 24px;">
            <div class="card-body" >
              <h4 class="card-title">Add Carousel Images</h4>             
          ...
          <?php
            if(isset($_POST['submitAdd'])){
              if(!empty($_FILES['imageKategori']['name'])){
                ...
                $image = uploadImage('Carousel', $pict);
                $result = "INSERT INTO tbl_admin_carousel (carousel_image) VALUES ('$image')";
                  ...
                  ?>
                    <script>
                      ...
                      text: 'Image Has Been Added',
                          ...
                          window.location = "homepageCarousel.php";
                      })
                    </script>
                  <?php
                }
            ...
            <h4 class="card-title" style="padding:12px 24px;">Images Data</h4>    
              <div class="table-responsive table-wrapper"  >
                <table class="table display" id="table">
                  ...
                  <?php
                    $i = 1;
                    $result = $conn->query("SELECT * FROM tbl_admin_carousel");
                    while($row = $result->fetch_assoc()) {
                      $id = $row['carousel_id'];
                      $image = $row['carousel_image']; 
                      echo "<tr>";
                      echo "<td style='padding:12px 24px;'>{$i}</td>";
                      echo "<td style='padding:12px 24px;'><img style='width:100px' src='../../UploadImage/Carousel/{$image}'></td>";
                      ?>
                      <form method="post">
                        <td>
                    ...
                    if (isset($_POST['updateData'])) {
                      ...
                      if (!empty($_FILES['imageKategoriUpdate']['name'])) {
                        ...
                        $result = "UPDATE tbl_admin_carousel SET carousel_image = '$image' WHERE carousel_id = '$id'";
                        if ($conn->query($result)) {
                          ?>
                          <script>
                            Swal.fire({
                  ...
                  if (isset($_POST['delete'])) {
                    $id = $_POST['id'];
                    $result = "DELETE FROM tbl_admin_carousel WHERE carousel_id = '$id'";
                    if ($conn->query($result)) {
                      ?>
                      <script>
                        Swal.fire({
